...
make -C $LUA_VER clean
make -j2 -C $LUA_VER BUILDMODE=static CC="$TARGET_CC" HOST_CC="gcc -m32 -arch i386" \
	TARGET_FLAGS="$ISDKF" TARGET_SYS="iOS" TARGET_AR="$TARGET_AR" TARGET_STRIP="$TARGET_STRIP"
# Build lua_wrap.a
mkdir -p ios
$TARGET_CC $ISDKF -c lua_wrap.c -o ios/lua_wrap.o -I$LUA_VER/src
$TARGET_AR ios/lua_wrap.a ios/lua_wrap.o
# Build libluanity-armv7.a
libtool -static -o ios/libluanity-armv7.a $LUA_VER/src/libluajit.a ios/lua_wrap.a
...
make -C $LUA_VER clean
make -j2 -C $LUA_VER BUILDMODE=static CC="$TARGET_CC" HOST_CC="gcc -m64 -arch x86_64" \
	TARGET_FLAGS="$ISDKF" TARGET_SYS="iOS" TARGET_AR="$TARGET_AR" TARGET_STRIP="$TARGET_STRIP"
# Build lua_wrap.a
$TARGET_CC $ISDKF -c lua_wrap.c -o ios/lua_wrap.o -I$LUA_VER/src
$TARGET_AR ios/lua_wrap.a ios/lua_wrap.o
# Build libluanity-arm64.a
libtool -static -o ios/libluanity-arm64.a $LUA_VER/src/libluajit.a ios/lua_wrap.a
